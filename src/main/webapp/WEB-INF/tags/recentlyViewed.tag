            ...
            <c:forEach var="viewed" items="${viewedProducts}">
                <td align="center" width="167">
                    <img class="product-tile"
                         src="https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/${viewed.imageUrl}"
                         align="center">
                    <p><br><a
                            href="${pageContext.servletContext.contextPath}/products/${viewed.id}">${viewed.description}</a><br>
